...
// @ts-ignore
import banner from '/public/image/banner1.png';
  ...
  return (
    <animated.div ref={ref} style={springs} className={s.container}>
      <div className='flex flex-col gap-10 items-start w-full'>
        ...
        Предоставляем каталог <span className='text-primary-500 ml-2'>Мотоциклов</span>
        </h1>
        <p className='text-base text-gray-500'>
        Наш сервис даёт возможность ознакомиться и в дальнейшем забронировать <br /> различные Мотоциклы
        </p>
